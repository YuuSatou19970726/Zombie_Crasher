...
public class BaseController : MonoBehaviour
{
    ...
    [SerializeField]
    private float accelerated = 15f, deccelarated = 10f;

    protected float rotationSpeed = 10f;
    protected float maxAngle = 10f;

    [SerializeField]
    private float low_Sound_Pitch, normal_Sound_Pitch, high_Sound_Pitch;

    [SerializeField]
    private AudioClip engine_On_Sound, engine_Off_Sound;
